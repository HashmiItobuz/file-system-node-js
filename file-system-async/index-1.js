...
function allOperation() {
    ...
    switch(Number(number)) {
        ...
        case 2:
            ...
            fs.writeFile(`${folder}/${fileName}`, "", (error) => {
                if(error) {
                    console.log("There is an error",`${error}`);
                }else {
        ...
        case 3:
            folder = prompt("Enter your directory name :");
            fileName = prompt("Enter your file name with extention: ");
            fs.readFile(`${folder}/${fileName}`, "UTF-8", (error, data) => {
                if(error) {
                    console.log("There is an error",`${error}`);
                }else {
                    console.log(data);
        ...
        case 4:
            ...
            fs.appendFile(`${folder}/${fileName}`, `${content}` , (error) => {
                if(error) {
                    console.log("There is an error",`${error}`);
                }else {
        ...
        case 5:
            ...
            fs.rename(`${folder}/${oldFile}`, `${folder}/${newFile}` , (error) => {
                if(error) {
                    console.log("There is an error",`${error}`);
                }else {
        ...
        case 6:
            ...
            fs.unlink(`${folder}/${deleteFile}`, (error) => {
                if(error) {
                    console.log("There is an error",`${error}`);
                }else {
        ...
        case 7:
            ...
            fs.rm(`${deleteDire}`, {recursive: true}, (error) => {
                if(error) {
                    console.log("There is an error",`${error}`);
                }else {
